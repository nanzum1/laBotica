...
<body>
	...
	<div class="container">
		...
		<form action="editarUsuario" method="POST">
			...
			<div class="mb-3">
				<div class="mb-3">
					<label for="run" class="form-label">Ingrese RUN del Usuario
					a modificar:</label> <input type="text" class="form-control" id="run"
						name="run" placeholder="12345678-K" pattern="^[0-9]+-[0-9kK]{1}$">
				</div>
